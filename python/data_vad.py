...
import librosa
from nnsp_pack import tfrecord_converter_vad
...
class FeatMultiProcsClass(multiprocessing.Process):
    ...
    def convert_tfrecord(
        ...
        for i in range(len(fnames) >> 1):
            ...
            audio = add_noise.add_noise(speech, noise, self.snr_db, stime, etime)
...
if __name__ == "__main__":
    ...
    argparser.add_argument(
        '-t',
        '--train_dataset_path',
        default = 'data/train_files_vad.csv',
        help    = 'path to train data file')

    argparser.add_argument(
        '--test_dataset_path',
        default = 'data/test_files_vad.csv',
